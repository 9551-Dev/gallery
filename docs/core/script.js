...
var image_paths = [
    "images/125 - automate automation code time twitter.png",
    "images/131 - coil driver sstc tesla teslacoil.jpg",
    "images/134 - bypass cc chart gpu hardware hardware_access issue kernel linux meme nuhuh shitpost skill skill_issue skillissue stack.png",
    "images/21 - coffee lie money poster.png",
    "images/23 - git git_commit git_push meme poster.png",
    "images/24 - graphical_programming spaghetti unreal_engine.png",
    "images/30 - developer documentation meme.png",
    "images/32 - legacy_code meme.png",
    "images/59 - humongous_spoon meme visual_studio xml.png",
    "images/62 - meme parallel template:flex_tape.png",
    "images/thumb.jpg"
];
